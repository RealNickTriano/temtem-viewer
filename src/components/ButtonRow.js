...
const ButtonRow = () => {
  return (
    <div>
      <button className='border-4 shadow-md border-black rounded-lg px-5 bg-white mt-4 font-bold text-black text-sm hover:bg-fuchsia-100 focus:bg-fuchsia-400'>Normal</button>
